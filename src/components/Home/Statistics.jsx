...
//   return (
//     <div className="p-4">
//       <h2 className="text-xl font-bold mb-4">Property Statistics</h2>

//       {/* Horizontal Scrollable Flex Container */}
//       <div className="flex justify-center space-x-4 overflow-x-auto overflow-y-auto  snap-x snap-mandatory scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200">
//         {/* Pie Chart */}
//         <div className="flex-shrink-0 snap-start w-[300px] md:w-[400px] h-[300px]">
...
const Statistics = () => {
  ...
  return (
    <div className="md:p-4">
      ...
      {/* Horizontal Scrollable Flex Container */}
      <div className="flex flex-col gap-4 md:flex-row justify-start space-y-6 md:space-y-0 md:space-x-4 overflow-x-auto snap-x snap-mandatory scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200">
  {/* Pie Chart */}
