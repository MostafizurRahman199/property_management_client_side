...
const UpdateProfile = () => {
    ...
    return (
        ...
        <div className="max-w-4xl w-full  shadow-2xl shadow-[#9c27b0]  rounded-2xl  p-8 flex items-center justify-center gap-2" data-aos='zoom-in-left'>
                    ...
                    <form onSubmit={handleUpdate}>
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                className="text-black w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#9c27b0]"
                            />
                        </div>
                        <div className="mb-4">
                        ...
                        <button
                            type="submit"
                            className="bg-[#9c27b0]  px-4 py-2 sm:px-8 sm:py-3 rounded-3xl text-white sm:font-semibold transition-transform hover:scale-105 shadow-2xl"
                        >
                            Update Information
                        </button>
                    </form>
